...
const WickedWheel = () => {
  ...
  const cx = 250
  const cy = 250
  const [state, setState] = useState({ x: 6, y: 10 });
...
return (
  ...
  <div><h1 className="Title">Wicked Wheel</h1> </div>
 
<div className="wheelHolder">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500"
    style={{  width: "300px",  heigt: "auto"}}>


    <g  fill=" #9e0017" stroke="white" strokeWidth="10">
